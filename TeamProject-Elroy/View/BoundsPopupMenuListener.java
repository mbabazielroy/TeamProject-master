...
// IMPORTANT! THIS IS AN EXTERNAL LIBRARY BROUGHT IN FOR THE SPECIFIC PURPOSE OF FORCING THE DROPDOWN MENU TO OPEN UPWARD
...
public class BoundsPopupMenuListener implements PopupMenuListener
{
	...
	protected void customizePopup(BasicComboPopup popup)
	{
		...
		if (popupAbove)
		{
			...
			((JComboBox) comboBox).setMaximumRowCount(26);
		}
		else
		{
